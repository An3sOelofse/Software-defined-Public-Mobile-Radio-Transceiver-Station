...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.selected_DCS = selected_DCS = 0
        ...
        self.uhd_usrp_sink_0.set_center_freq(tuning+6250+(12500*selected_channel), 0)
        ...
        self.qtgui_sink_x_0_1_0_0_1_0_0 = qtgui.sink_f(
            32768, #fftsize
        ...
        self.qtgui_sink_x_0_1_0_0_1_0_0.set_update_time(1.0/100)
        self._qtgui_sink_x_0_1_0_0_1_0_0_win = sip.wrapinstance(self.qtgui_sink_x_0_1_0_0_1_0_0.qwidget(), Qt.QWidget)

        self.qtgui_sink_x_0_1_0_0_1_0_0.enable_rf_freq(False)

        self.top_layout.addWidget(self._qtgui_sink_x_0_1_0_0_1_0_0_win)
        self.qtgui_sink_x_0_1_0_0_1_0 = qtgui.sink_f(
            32768, #fftsize
            window.WIN_BLACKMAN_hARRIS, #wintype
            0, #fc
            48000, #bw
        ...
        self.qtgui_sink_x_0_1_0_0_1_0.set_update_time(1.0/100)
        self._qtgui_sink_x_0_1_0_0_1_0_win = sip.wrapinstance(self.qtgui_sink_x_0_1_0_0_1_0.qwidget(), Qt.QWidget)

        self.qtgui_sink_x_0_1_0_0_1_0.enable_rf_freq(False)

        self.top_layout.addWidget(self._qtgui_sink_x_0_1_0_0_1_0_win)
        ...
        self.qtgui_sink_x_0_1_0_0.set_update_time(1.0/100)
        self._qtgui_sink_x_0_1_0_0_win = sip.wrapinstance(self.qtgui_sink_x_0_1_0_0.qwidget(), Qt.QWidget)

        self.qtgui_sink_x_0_1_0_0.enable_rf_freq(True)
        ...
        self.high_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.epy_block_1 = epy_block_1.blk(selected_dcs_code=0)
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.qtgui_sink_x_0_1_0_0_1_0_0, 0))
        ...
        self.connect((self.epy_block_1, 0), (self.audio_sink_0, 0))
        ...
        self.connect((self.low_pass_filter_0_1_0_0, 0), (self.qtgui_sink_x_0_1_0_0_1_0, 0))
        self.connect((self.low_pass_filter_0_1_0_0_0, 0), (self.digital_binary_slicer_fb_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.qtgui_sink_x_0_1_0_0, 0))
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self.qtgui_sink_x_0_1_0_0.set_frequency_range(self.tuning, 200000)
        self.uhd_usrp_sink_0.set_center_freq(self.tuning+6250+(12500*self.selected_channel), 0)
